...
function Movies() {
  ...
  return (
    <main className="container mx-auto px-4 py-8 space-y-12">
      ...
      <section>
        <h2 className="text-2xl font-bold text-[#f24333] mb-6">Featured Movies</h2>
      ...
      {/* Genres Section */}
      <section>
        <h2 className="text-2xl font-bold text-[#f24333] mb-6">Browse by Genre</h2>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {selectedGenre && selectedGenre.id !== 28 && (
            <button 
              ...
              className="text-[#f24333] hover:text-[#f24333] transition-colors duration-300"
            >
              Reset to Action
            </button>
          )}
